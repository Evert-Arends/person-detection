...
def assign_detections_to_trackers(trackers, detections, iou_thrd=0.2):
    '''
...
if __name__ == "__main__":
    ...
    if debug:  # test on a sequence of images
        ...
        # start=time.time()
        # output = 'test_v7.mp4'
        # clip1 = VideoFileClip("multiple_people.mp4")#.subclip(4,49) # The first 8 seconds doesn't have any cars...
